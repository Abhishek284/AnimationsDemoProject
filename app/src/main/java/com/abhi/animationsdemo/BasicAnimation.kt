...
import kotlinx.android.synthetic.main.activity_basic_animation.*

class BasicAnimation : AppCompatActivity(), Animator.AnimatorListener {
    ...
    fun rotateAnimation(view: View) {
        ...
        rotateAnimator?.apply {
            ...
            addListener(this@BasicAnimation)
            start()
        }
    }
...
inline fun String.test(string: String): Boolean {
    return true
}
